...
<div class="container-fluid bg-1 text-center row">
    ...
    <div class="col-xs-4 col-sm-3 col-md-2 col-lg-1">
        <button class="btn-info" style="height: 50%; width: 50%; margin-bottom: 10px"><a href="#"><img src="media/icons/chassis%202.png" style="height: 100%; width: 100%"></a></button>
    </div>
    <div class="col-xs-4 col-sm-3 col-md-2 col-lg-1">
        <button class="btn-default" style="height: 50%; width: 50%; margin-bottom: 10px"><a href="conf3.php"><img src="media/icons/engine.png" style="height: 100%; width: 100%"></a></button>
    </div>
    <div class="col-xs-4 col-sm-3 col-md-2 col-lg-1">
        <button class="btn-default" style="height: 50%; width: 50%; margin-bottom: 10px"><a href="conf4.php"><img src="media/icons/gearbox.png" style="height: 100%; width: 100%"></a></button>
    </div>
    <div class="col-xs-4 col-sm-3 col-md-2 col-lg-1">
        <button class="btn-default" style="height: 50%; width: 50%; margin-bottom: 10px"><a href="conf5.php"><img src="media/icons/chassis.png" style="height: 100%; width: 100%"></a></button>
    </div>
    <div class="col-xs-4 col-sm-3 col-md-2 col-lg-1">
        <button class="btn-default" style="height: 50%; width: 50%; margin-bottom: 10px"><a href="conf6.php"><img src="media/icons/car%20body.png" style="height: 100%; width: 100%"></a></button>
    </div>
    <div class="col-xs-4 col-sm-3 col-md-2 col-lg-1">
        <button class="btn-default" style="height: 50%; width: 50%; margin-bottom: 10px"><a href="conf7.php"><img src="media/icons/tires.png" style="height: 100%; width: 100%"></a></button>
    </div>
    <div class="col-xs-0 col-sm-0 col-md-0 col-lg-1">
    </div>
</div>
...
<div class="container-fluid bg-3 text-center">
    <div class="row">
        <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6">
            <img src = "media/icons/chassis%202.png" class="margin" style="display:inline" alt="Car" width="600" height="155">
        </div>
