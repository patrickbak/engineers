...
<div class="container-fluid bg-1 text-center row">
    ...
    <div class="col-xs-4 col-sm-3 col-md-2 col-lg-1">
        <button class="btn-info" style="height: 50%; width: 50%; margin-bottom: 10px"><a href="#"><img src="media/icons/gearbox.png" style="height: 100%; width: 100%"></a></button>
    </div>
    <div class="col-xs-4 col-sm-3 col-md-2 col-lg-1">
...
<div class="container-fluid bg-3 text-center">
    <div class="row">
        <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6">
            <img src = "media/icons/gearbox.png" class="margin" style="display:inline" alt="Car" width="454" height="300">
        </div>
